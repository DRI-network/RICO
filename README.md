...
| totalSupply | uint256 | totalSupply is a represent maximum supply quantities in Token strategy. literal `ether` mean 10**18 on EVM execution. this case is decimals equal 18, this token available ether literal.`400000 ether` mean that 400,000 Token will be mint. |
...
| tobAmountWei | uint256| represent a Project TOB Cap o ETH. |
...
| PoDCapWei | uint256 | represent a Project HardCap of ETH.|
